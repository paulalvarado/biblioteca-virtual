...
@section('contenido')
    ...
    <script>
        jQuery('.pagination-container').pagination({
            ...
            prevClassName: 'btn-pagination flex items-center justify-center px-3 h-8 ml-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-l-lg cursor-pointer',
            nextClassName: 'btn-pagination flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 rounded-r-lg cursor-pointer',
            // clase para los botontes ...
            classPrefix: 'btn-pagination flex items-center justify-center px-3 h-8 leading-tight border border-gray-500',
        })
